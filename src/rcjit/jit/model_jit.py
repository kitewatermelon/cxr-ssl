...
from rcjit.jit.util.model_util import VisionRotaryEmbeddingFast, get_2d_sincos_pos_embed, RMSNorm
...
def JiT_S_16(**kwargs):
    return JiT(depth=12, hidden_size=384, num_heads=6,
               bottleneck_dim=64, in_context_len=16, in_context_start=4, patch_size=16, **kwargs)

def JiT_S_32(**kwargs):
    return JiT(depth=12, hidden_size=384, num_heads=6,
               bottleneck_dim=64, in_context_len=16, in_context_start=4, patch_size=32, **kwargs)
