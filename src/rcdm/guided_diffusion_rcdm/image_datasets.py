...
class HFImageDataset(Dataset):
    def __init__(self, hf_dataset, image_size, shard=0, num_shards=1,
                 random_crop=False, random_flip=True, class_cond=False):
        super().__init__()
        self.dataset = hf_dataset.shard(num_shards=num_shards, index=shard)
    ...
    def __getitem__(self, idx):
        ...
        if self.random_crop:
            ...
            arr  = center_crop_arr(pil_image, self.image_size)
